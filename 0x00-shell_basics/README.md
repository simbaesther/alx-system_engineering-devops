...
school.mgc - Create a magic file school.mgc that can be used with the command file to detect School data files. School data files always contain the string SCHOOL at offset 0. -- this task was different so I created a file with the following command: 
    0 string SCHOOL School data
    !:mime School
 and then on the terminal I compiled the file with the command : file -C -m school.mgc
